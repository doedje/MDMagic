...
;(function(window, document) {
  ...
  /*
  REMY BLOM: Okay.... I am going to skip this piece of magic right here....
  Mainly because it is not working in my setup, I use $.getScript to load this file (strapdown.js)
  And I don't like the fact that the markdown is shown before the css is even loaded...
  So the stylesheets are in my html...
  ...
  // fixing originBase, cause I don't use a F*CK*N script-tag..... pffffffst
  // var originBase = origin.substr(0, origin.lastIndexOf('/'));
  var originBase = './../vendor/strapdown';
